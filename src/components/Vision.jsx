					...
					<div className="row align-items-center">
						<div className="col-12 col-md-6 col-xs-12 pl-lg-5 mb-4 mb-md-0 centrado">
							...
							<ul className="textos style0" data-aos="fade-right" data-aos-delay="600" >
								<li className="mb-3 mb-xl-4">We started by developing the optimization and trade execution systems needed by specialized protocols such as <span className="morado-bold">COW protocol</span>.</li>
