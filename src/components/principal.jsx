...
const Principal = () => {
	return (
		<div className="panel-pin" data-theme="white">
                ...
                <div className="container-fluid w-14">
                    <div className="row justify-content-center">
                        <div className="col-12">
                            <h1 className="tlo-main mb-0">OPTIMAL <br /> TRADE</h1>
            ...
            {/* Que es Otex */}
            <div className="principal d-flex flex-column justify-content-between">
                <div className="container-fluid w-14">
                    <div className="row">
                        <div className="col-12 col-md-6 col-xl-5 mb-4 text-center text-md-left">
                            <h1 className="titulos">WHAT’S OTEX</h1>
                        </div>        
                        <div className="col-12 col-md-6 col-xl-7 pl-xl-5 text-justify">
